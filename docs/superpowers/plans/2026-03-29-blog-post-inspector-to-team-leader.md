# Blog Post: From Inspector to Team Leader Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Write and publish a personal narrative blog post about the transition from Quality Control Inspector to Quality Team Leader.

**Architecture:** Single markdown file in `_posts/` following al-folio Jekyll conventions. Frontmatter defines metadata; body is narrative prose structured in 5 sections per the spec.

**Tech Stack:** Jekyll, al-folio theme, Markdown
...
Create `_posts/2026-03-29-inspector-to-team-leader.md` with the following content:
...
description: Reflections on moving from Quality Control Inspector to Quality Team Leader - the mindset shift, the surprises, and what I would tell myself before making the move.
tags: quality management career
categories: quality-management
---

There is a moment I keep coming back to from my early days as a Quality Team Leader. A non-conformance had been raised on the shop floor and my first instinct was to get up, walk over, and sort it out myself. I knew exactly what to look for. I had done it hundreds of times. It would have taken me ten minutes.

I sat back down.

Not because I was lazy or disinterested, but because I had just realised something: that instinct, the one that had served me well for over a decade as an inspector, was now the wrong instinct. My job was no longer to find and fix problems. It was to build a team and a system that could do that without me.
...
```bash
git add _posts/2026-03-29-inspector-to-team-leader.md
git commit -m "content: add blog post - from inspector to team leader"
```
